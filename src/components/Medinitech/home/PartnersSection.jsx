...
function PartnersSection() {
  ...
  useEffect(() => {
    ...
    }, 16); // Using 16ms for smoother animation (roughly 60fps)
    ...
    <section className="py-24 bg-white dark:bg-gray-900 flex items-center">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center md:items-center gap-12">
          ...
          <div className="md:w-1/2 flex gap-0 overflow-hidden relative">
            {/* Grey shade dividers between columns */}
            <div className="absolute inset-0 z-10 pointer-events-none">
              <div className="h-full w-[1px] bg-gradient-to-b from-transparent via-gray-300 to-transparent absolute left-[25%]"></div>
              <div className="h-full w-[1px] bg-gradient-to-b from-transparent via-gray-300 to-transparent absolute left-[50%]"></div>
              <div className="h-full w-[1px] bg-gradient-to-b from-transparent via-gray-300 to-transparent absolute left-[75%]"></div>
            </div>
            {/* Column 1 - Moving Up Continuously */}
            <div className="w-[25%] overflow-hidden relative h-[400px] pr-0 mr-0 bg-gradient-to-b from-white via-gray-50 to-white">
              {/* First set of logos */}
              <div 
              ...
              {/* Duplicate set for seamless looping - positioned right after the first set */}
              <div 
                className="flex flex-col gap-4 absolute w-full transition-transform duration-1000 ease-linear" 
            ...
            <div className="w-[25%] overflow-hidden relative h-[400px] pl-0 ml-0 bg-gradient-to-b from-white via-gray-50 to-white">
              {/* First set of logos */}
              <div 
                className="flex flex-col gap-4 absolute w-full transition-transform duration-1000 ease-linear" 
              ...
              {/* Duplicate set for seamless looping - positioned right before the first set */}
              <div 
                className="flex flex-col gap-4 absolute w-full transition-transform duration-1000 ease-linear" 
                style={{ transform: `translateY(${scrollPosition2 - 100}%)` }}
              >
                {partnersColumn2.map((partner) => (
                  <div
                    key={`dup-${partner.id}`}
