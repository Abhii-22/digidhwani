...
const SLIDER_CONTENT = [
  {
    image: `${image1}?height=1200&width=1920&color=blue`,
  ...
  {
    image: `${image2}?height=1200&width=1920&color=purple`, 
  ...
  {
    image: `${image3}?height=1200&width=1920&color=teal`,
    title: "Digital Transformation Experts",
    description: "Empowering your business with advanced technological insights",
          ...
          currentSlide === index && (
            ...
            >
              ...
              <div className="relative z-10 container mx-auto h-full flex items-center px-6">
                <div className="max-w-xl text-black dark:text-white space-y-6">
                  <motion.h1 
                  ...
                  <motion.p
                    ...
                    className="text-lg mb-6 text-gray-800 dark:text-gray-200"
                  >
                    {slide.description}
                  </motion.p>
